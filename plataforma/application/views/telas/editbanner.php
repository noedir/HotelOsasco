            ...
            <div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Editar Banner</h2>
						<div class="box-icon">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<div class="uploader" id="uniform-fileInput">
                                                                    ...
                                                                    <input type="hidden" name="afoto" value="<?php echo $banner[0]->ba_imagem; ?>">
                                                              ...
                                                              <br>
                                                                <img src="../../../banner/<?php echo $banner[0]->ba_imagem; ?>">
							  </div>
							</div>
                                                        <div class="control-group">
							  <label for="link" class="control-label">Link </label>
							  <div class="controls">
								<input type="text" value="<?php echo $banner[0]->ba_link; ?>" id="link" class="span3 typeahead" name="link">
							  </div>
							</div>
                                                      <div class="control-group">
								...
								<div class="controls">
								  <select id="alvo" name="alvo" class="span3">
									<option value="_blank"<?php print $banner[0]->ba_alvo == '_blank' ? 'selected="selected"' : "" ; ?>>Nova Janela</option>
									<option value="_self"<?php print $banner[0]->ba_alvo == '_self' ? 'selected="selected"' : "" ; ?>>Mesma Janela</option>
								  </select>
								</div>
							  </div>
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary">Salvar</button>
                                                          <input type="hidden" name="codigo" value="<?php echo $banner[0]->ba_codigo; ?>">
							</div>
						  </fieldset>
						</form>
					</div>
